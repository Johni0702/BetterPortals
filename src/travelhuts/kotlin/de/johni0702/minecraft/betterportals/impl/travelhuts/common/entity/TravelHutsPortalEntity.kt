...
import de.johni0702.minecraft.betterportals.impl.travelhuts.BPTravelHutsMod.Companion.PORTAL_CONFIG
...
open class TravelHutsPortalAgent(manager: PortalManager) : PortalEntityPortalAgent(manager, PORTAL_CONFIG) {
